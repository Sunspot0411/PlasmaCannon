...
public class RenderPlasmaBall extends Render<EntityPlasmaBall>
{
    private final float scale;

    public RenderPlasmaBall(RenderManager renderManagerIn, float scaleIn)
    {
     ...
     */
    public void doRender(EntityPlasmaBall entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityPlasmaBall entity)
    {
