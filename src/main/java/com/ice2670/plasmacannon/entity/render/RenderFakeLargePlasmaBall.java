package com.ice2670.plasmacannon.entity.render;
...
public class RenderFakeLargePlasmaBall extends Render<FakeEntityLargePlasmaBall>
{
    ...
    public RenderFakeLargePlasmaBall(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(FakeEntityLargePlasmaBall entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    protected ResourceLocation getEntityTexture(FakeEntityLargePlasmaBall entity) {
